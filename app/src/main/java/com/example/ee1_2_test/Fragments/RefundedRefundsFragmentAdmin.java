...
public class RefundedRefundsFragmentAdmin extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        getActivity().setTitle("Refunded Refund Requests");
        View view = inflater.inflate(R.layout.admin_fragment_refunded_refunds,container,false);

        refundRequests_recyclerview_user = view.findViewById(R.id.viewallRefundedrefunds_recyclerview_admin);
    ...
    private void getResponse() {
        ...
        Call<List<Refund>> call = bookstoreApi.getRefundedRefundRequests();
