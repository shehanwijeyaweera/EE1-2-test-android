...
public class BookRequestFragmentAdmin extends Fragment {

    private RecyclerView recyclerViewRequest;
    private BookstoreApi bookstoreApi;
    private adminViewAllRequestAdapter adminViewAllRequestAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.admin_fragment_bookrequest,container,false);

        recyclerViewRequest = view.findViewById(R.id.requestbook_recyclerview_admin);
