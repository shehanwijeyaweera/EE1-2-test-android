...
public class adminViewAllBooksAdapter extends RecyclerView.Adapter<adminViewAllBooksAdapter.ViewHolder> {
    ...
    public adminViewAllBooksAdapter(ArrayList<Book> books, Context context) {
        this.books = books;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new adminViewAllBooksAdapter.ViewHolder(view);
    }
