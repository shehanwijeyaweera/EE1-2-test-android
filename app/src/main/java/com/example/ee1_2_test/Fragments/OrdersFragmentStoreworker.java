...
public class OrdersFragmentStoreworker extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.storeworker_fragment_orders,container,false);

        orders_recyclerview_admin = view.findViewById(R.id.orders_recyclerview_storeworker);
